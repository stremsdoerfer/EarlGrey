...
#import "Assertion/GREYFatalAsserts.h"
...
+ (void)addInstanceMethodToClass:(Class)destination
  ...
  GREYFatalAssertWithMessage(instanceMethod, @"Instance method: %@ does not exist in the class %@.",
                             NSStringFromSelector(methodSelector), source);
  ...
  BOOL success = class_addMethod(destination, methodSelector,
