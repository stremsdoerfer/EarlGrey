...
- (void)greyswizzled_markStart:(double)startTime {
  ...
  objc_setAssociatedObject(self, @selector(greyswizzled_markStart:), object,
...
- (void)greyswizzled_markStop {
  ...
  objc_setAssociatedObject(self, @selector(greyswizzled_markStart:), nil, OBJC_ASSOCIATION_ASSIGN);
