...
- (void)grey_track {
  ...
  if (!isIgnored) {
    ...
    // prevents this.
    objc_setAssociatedObject(self, @selector(grey_track), object, OBJC_ASSOCIATION_RETAIN);
  }
}
...
- (void)grey_untrack {
  ...
  if (object) {
    ...
    objc_setAssociatedObject(self, @selector(grey_track), nil, OBJC_ASSOCIATION_ASSIGN);
  }
}
